...
form AsistenteRetiroPascuaForm "Asistente Retiro Pascua Form" : AsistenteRetiroPascua {
    ...
    descripcionEvento       : String, internal, optional;
...
form AsistenteRetiroDePascuaFormListing {
    header {
    ...
    asistentesRetiroPascua : AsistenteRetiroPascua, table(10), on_load loadAsistentes, sortable {
...
form PersonaRelacionadaRetiroDePascuaForm {
    header {
        message(title), col 12;
    };
